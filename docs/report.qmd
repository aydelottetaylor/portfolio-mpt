...
The dashboard can be accessed [here](https://portfolio-mpt.streamlit.app/) and consists of multiple tabs:
...
This **portfolio-mpt** project provides a full ecosystem for Modern Portfolio
